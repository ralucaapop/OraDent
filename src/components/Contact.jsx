    ...
    return (
        <div className={styles.contact_container}>
            ...
            <p className={styles.contact_description}>
                Pentru orice întrebări sau informații suplimentare, nu ezitați să ne contactați. Urmăriți-ne pe rețelele sociale pentru a fi la curent cu ultimele noutăți și evenimente.
                <div className={styles.contact}>
                    <img className={styles.contact_icon} src={mail} alt="Email Icon"/>
                    <h3 className={styles.contact_name}>adresadeemail@gmai.com</h3>
                </div>
                <div className={styles.contact}>
